...
subplots_fig.suptitle("LMBGE Joint Function And Gradient Estimation - Gradient Descent", fontsize=14)
...
@printf("====Table Values====\n")
@printf("Gradient Descent F&GE Mean Number Of Objective Evaluations: %d\n", mean(obj_fun_eval_counts))
@printf("Gradient Descent F&GE Median Number Of Objective Evaluations: %d\n", median(obj_fun_eval_counts))
@printf("Gradient Descent F&GE Mean Log10 Optimality Gap: %1.1E\n", mean(log.(10,all_true_obj_fun_vals[end,:].-obj_fun_min_val)))
@printf("Gradient Descent F&GE Median Log10 Optimality Gap: %1.1E\n", median(log.(10,all_true_obj_fun_vals[end,:].-obj_fun_min_val)))
