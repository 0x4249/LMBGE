...
subplots_fig.suptitle("LMBGE Gradient Estimation - BFGS", fontsize=14)
...
@printf("====Table Values====\n")
@printf("BFGS GE Mean Number Of Objective Evaluations: %d\n", mean(obj_fun_eval_counts))
@printf("BFGS GE Median Number Of Objective Evaluations: %d\n", median(obj_fun_eval_counts))
@printf("BFGS GE Mean Log10 Optimality Gap: %1.1E\n", mean(log.(10,all_true_obj_fun_vals[end,:].-obj_fun_min_val)))
@printf("BFGS GE Median Log10 Optimality Gap: %1.1E\n", median(log.(10,all_true_obj_fun_vals[end,:].-obj_fun_min_val)))
